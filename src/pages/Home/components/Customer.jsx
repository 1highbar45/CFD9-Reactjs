            ...
            <div className="container">
                ...
                <div className="testimonial">
                    <div className="testimonial-item">
                        <div className="item">
                            ...
                            <div className="images">
                                <div className="list flickity-enabled is-draggable" tabIndex={0}>
                                    <div className="flickity-viewport" style={{ height: 460, touchAction: 'pan-y' }}><div className="flickity-slider" style={{ left: 0, transform: 'translateX(0%)' }}><div className="carousel-cell is-selected" style={{ position: 'absolute', left: '0%' }}>
                                        <div className="img">
                                            <picture>
                                                <source media="(max-width: 767px)" srcSet="img/Intersect.png" />
                                                <img alt src="img/tes.jpg" className="flickity-lazyloaded" style={{ transform: 'translateX(0px)' }} />
                                            </picture>
                                        </div>
                                        <div className="ct_m">
                                            <div className="info">
                                    ...
                                    </div><div className="carousel-cell" aria-hidden="true" style={{ position: 'absolute', left: '100%' }}>
                                            <div className="img">
                                                <picture>
                                                    <source media="(max-width: 767px)" srcSet="img/Intersect.png" />
                                                    <img alt src="img/tes.jpg" className="flickity-lazyloaded" style={{ transform: 'translateX(-195.875px)' }} />
                                                </picture>
                                            </div>
                                            <div className="ct_m">
                                                <div className="info">
                                        ...
                                        </div><div className="carousel-cell" aria-hidden="true" style={{ position: 'absolute', left: '200%' }}>
                                            <div className="img">
                                                <picture>
                                                    <source media="(max-width: 767px)" srcSet="img/Intersect.png" />
                                                    <img alt src="img/tes.jpg" className="flickity-lazyloaded" style={{ transform: 'translateX(-391.75px)' }} />
                                                </picture>
                                            </div>
                                            <div className="ct_m">
                                                <div className="info">
                        ...
                        <div className="dots"><ol className="flickity-page-dots"><li className="dot is-selected" aria-label="Page dot 1" aria-current="step" /><li className="dot" aria-label="Page dot 2" /><li className="dot" aria-label="Page dot 3" /></ol></div>
