...
export default function Course() {
    const courses = [
        {
            courseImage: "/img/img1.png",
            name: "Front-end căn bản",
            des: "One of the best corporate fashion brands in Sydney",
            teacherImage: "/img/avt.png",
            teacher: "Trần Nghĩa"
        },
        {
            courseImage: "/img/img.png",
            name: "React JS",
            des: "One of the best corporate fashion brands in Sydney",
            teacherImage: "/img/avt.png",
            teacher: "Vương Đặng"
            ...
            <section className="section-1">
                <div className="container">
                    ...
                    <div className="list row">
                        {
                            courses.map((e,i) => (
                                <Link to={`/khoa-hoc/${e.link}`} className="col-md-4 course" key={i}>
                                    <div className="wrap">
                                        <a className="cover" href="#">
                                            <img src={e.courseImage} alt />
                                        </a>
                                        <div className="info">
                                        ...
                                        <div className="bottom">
                                            <div className="teacher">
                                                <div className="avatar">
                                                    <img src={e.teacherImage} alt />
                                                </div>
                                                <div className="name">{e.teacher}</div>
                                            </div>
